...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plumbing_pub_sub-msg:<Num> is deprecated: use plumbing_pub_sub-msg:Num instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_pub_sub-msg:first_name-val is deprecated.  Use plumbing_pub_sub-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_pub_sub-msg:last_name-val is deprecated.  Use plumbing_pub_sub-msg:last_name instead.")
  (last_name m))
...
(cl:defmethod score-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plumbing_pub_sub-msg:score-val is deprecated.  Use plumbing_pub_sub-msg:score instead.")
  (score m))
