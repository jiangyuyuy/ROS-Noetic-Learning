...
if __name__ == "__main__":
    ...
    #获取参数
    int_value = rospy.get_param("p_int_x",10000)
    double_value = rospy.get_param("p_double", 4.14)
    bool_value = rospy.get_param("p_bool", False)
    string_value = rospy.get_param("p_string", "Linux is yyds")
    p_list = rospy.get_param("p_list", [1, 2, 3, 4])
